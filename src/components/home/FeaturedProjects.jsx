    ...
    >
      <Container>
        <SectionHeading
          ...
          description="Manipulation, learning and autonomy — from integrated workcells to interpretable multi-robot systems."
        />
        ...
        <div className="competition-projects">
          {featuredProjects.slice(3).map((project) => (
            <ProjectFeature key={project.slug} project={project} compact />
          ))}
        </div>
      </Container>
    </section>
